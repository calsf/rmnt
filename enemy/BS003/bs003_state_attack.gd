# Custom attack state for BS003
# Includes teleport methods to be used in animations
extends EnemyState
...
func teleport_to_player():
	...
	enemy.enemy_child.global_position = player.get_player_child().global_position
